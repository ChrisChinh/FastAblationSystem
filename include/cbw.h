...
#define RISING_SEN_EDGE		0
#define FALLING_SEN_EDGE    1
#define ABOVE_SEN_LEVEL		2
#define BELOW_SEN_LEVEL		3
#define EQ_SEN_LEVEL		4
#define NE_SEN_LEVEL		5
#define HIGH_SEN_LEVEL		6
#define LOW_SEN_LEVEL		7
